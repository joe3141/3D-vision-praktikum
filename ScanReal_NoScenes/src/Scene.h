...
public:
	...
	bool renderDepthSemantics(GraphicsDevice& g, unsigned int idx, mat4f& intrinsic, mat4f& extrinsic, DepthImage32& depth, BaseImage<unsigned char>& semantics, BaseImage<unsigned char>& instance, BaseImage<unsigned char>& instance_gt, BaseImage <vec3f>& colorImage);
